...
Мы помогаем Вашему бизнесу <b>снижать издержки</b> и <b>ускорять процессы</b> за счёт <b>автоматизации</b> и <b>ИИ</b>.

Работаем с уже существующими процессами: не меняем их с нуля, а точечно оптимизируем - <b>убираем лишние операции</b>, <b>сокращаем ручной труд и количество ошибок</b>, чтобы те же процессы работали быстрее и дешевле.

Есть опыт работы с компаниями всех масштабов - от стартапов до крупного бизнеса (NDA).

<tg-emoji emoji-id="5203996991054432397">🎁</tg-emoji> Сейчас мы работаем на имя, поэтому готовы провести Вам <b>бесплатный аудит</b> и показать, где можно <b>сократить издержки</b> или <b>увеличить эффективность в x3-5 раз</b>

Выберите раздел:
"""

TEXT_SERVICES = """<tg-emoji emoji-id="5368589393491669392">⚙️</tg-emoji> <b>Услуги</b>
...
TEXT_DEV = """🛠 <b>Разработка под ключ</b>

👀 Возможно, Вам <b>вообще не нужен ИИ</b> - иногда ключевую роль играет хорошо проработанная внутренняя система, которая объединяет всё нужное в одном месте.

В таком случае мы можем разработать для Вас <b>внутреннее ПО</b>, <b>мобильное приложение</b>, <b>веб-платформу</b> или <b>Telegram-бота</b> любой сложности.

Работаем небольшой командой без лишних уровней согласований - задачи сразу попадают к разработчикам. За счёт этого <b>быстрее доводим идею до рабочего решения</b> и сохраняем качество.

Опыт в этом у нас тоже есть:
...
TEXT_AUTOMATION = """<tg-emoji emoji-id="5327931798548665621">🤖</tg-emoji> <b>Внедрение ИИ</b>
...
Также, за счёт компактности команды, решения получаются сильно <b>менее затратными</b>, чем у крупных подрядчиков, при сохранении фокуса на результате

<tg-emoji emoji-id="5224288323526235012">🧐</tg-emoji> <b>Не доверяете ИИ?</b>
Мы также предлагаем Вам <b>подписочный формат</b>: разрабатываем для Вас решение, и Вы оплачиваете его по месяцам; если результат не устроит, то просто прекратите подписку.
...
TEXT_CASES = """<tg-emoji emoji-id="5303209807879093100">💼</tg-emoji> <b>Кейсы</b>

Практический результат — главный показатель нашей компетенции. Ознакомьтесь с примерами задач, которые мы уже успешно решили для наших клиентов:

<a href="https://telegra.ph/Kejs-Razrabotka-AI-assistenta-dlya-avtomaticheskoj-generacii-dizajn-specifikacij-LLM-Progger-02-19">AI-Ассистент генерации ТЗ</a>
<blockquote>Нейросеть превращает хаотичные идеи в строгие дизайн-спецификации.
<b>Результат:</b> Подготовка ТЗ сокращена <b>с 2 дней до 2 минут</b> и полностью исключило споры между отделами.</blockquote>

<a href="https://telegra.ph/Kejs-Razrabotka-sredy-dlya-paketnogo-testirovaniya-i-otladki-promptov-lokalnyh-LLM-02-19">Среда для работы с локальной LLM</a>
<blockquote>Лаборатория для инженеров по пакетному тестированию промптов.
<b>Результат:</b> Ускорена разработка промптов <b>в 3 раза</b>, а проверка гипотез сократилась с 5 минут до 30 секунд при <b>полной приватности</b> данных.</blockquote>

<a href="https://telegra.ph/Kejs-Razrabotka-AI-mikroservisa-dlya-avtomaticheskogo-razbora-zakazov-iz-telefonnyh-zvonkov-02-19">AI-Микросервис для колл-центров</a>
<blockquote>Нейросеть автоматически разбирает звонки и работает с CRM.
<b>Результат:</b> Обработка заказов ускорена <b>с минут до секунд</b> при <b>100% точности</b> ввода адресов в CRM.</blockquote>

<a href="https://telegra.ph/Vot-kejs-sostavlennyj-na-osnove-analiza-koda-LeadQuest-AI--DISC-Academy-02-19">Образовательная платформа (EdTech)</a>
<blockquote>Индивидуальный трек обучения с адаптивной аналитикой успеваемости.
<b>Результат:</b> Персонализация обучения повысила вовлеченность учеников <b>на 40%</b> и увеличила время сессий.</blockquote>

<a href="https://telegra.ph/Kejs-Razrabotka-AI-sistemy-institucionalnoj-analitiki-kriptovalyutnogo-rynka-02-19">Система институциональной аналитики</a>
<blockquote>Интеллектуальный анализ больших данных и предиктивная аналитика.
<b>Результат:</b> Инструмент позволяет видеть скрытые закономерности на сложных рынках.</blockquote>

<a href="https://telegra.ph/Kejs-Razrabotka-multiagentnoj-sistemy-dlya-avtomatizacii-SMM-v-Telegram-02-19">Мультиагентная система SMM в Telegram</a>
<blockquote>Команда виртуальных ботов, которые сами ищут инфоповоды и пишут тексты.
<b>Результат:</b> Производство контента ускорилось <b>в 20 раз</b>, позволяя одному менеджеру вести <b>более 20 каналов</b>.</blockquote>

<a href="https://telegra.ph/Kejs-Razrabotka-korporativnoj-sistemy-upravleniya-proektami-i-rezervnym-kopirovaniem-PBMS-02-19">Корпоративная система PBMS</a>
<blockquote>Единый центр управления проектами с архитектурой резервного копирования.
<b>Результат:</b> Система <b>полностью устранила</b> риск потери данных и <b>вдвое ускорила поиск</b> документации.</blockquote>

<a href="https://telegra.ph/Kejs-Razrabotka-oblachnogo-menedzhera-skriptov-s-veb-interfejsom-CloudBase-02-19">Облачный менеджер CloudBase</a>
<blockquote>Удобный веб-интерфейс для централизованного управления скриптами.
<b>Результат:</b> Персональное облако для управления кодом стало доступно с любого смартфона <b>в один клик</b>.</blockquote>

Оставьте заявку, чтобы мы могли реализовать похожий результат для Вашей компании.
"""
...
TEXT_CONTACT_PROMPT = f"""<tg-emoji emoji-id="5296369303661067030">🔒</tg-emoji> Благодарим за информацию. Пожалуйста, нажмите кнопку ниже, чтобы
поделиться Вашим контактом. Мы гарантируем конфиденциальность и используем его
исключительно для связи по Вашему проекту.
"""
# Нажимая кнопку, Вы соглашаетесь с
# <a href="{PRIVACY_POLICY_URL_SAFE}">Политикой конфиденциальности</a>


TEXT_LEAD_DONE = """<tg-emoji emoji-id="5316939641503365999">✅</tg-emoji> Спасибо за доверие! Ваша заявка принята. Мы ознакомимся с деталями и свяжемся с Вами в ближайшее время для предметного обсуждения."""
...
Видим, что вчера вы изучали наши кейсы и услуги. Обычно на этом этапе возникают технические вопросы или потребность в предварительной оценке сложности проекта. Мы готовы проконсультировать вас прямо здесь. Просто <b>напишите ваш вопрос ответным сообщением</b>, и наш специалист ответит вам в ближайшее время."""

NUDGE_SILENT = f"""Здравствуйте! Пару дней назад Вы запускали нашего бота.
Если у вас появилась идея для автоматизации или конкретная задача по разработке — мы на связи и готовы помочь с реализацией. Не обязательно заполнять всю заявку сразу: вы можете просто <b>описать суть задачи в свободном формате</b> прямо в этом чате. Мы подскажем, какое решение подойдет именно вам."""

# NUDGE_SLEEP = f"""Краткая новость от нашей команды ⚡️
...
BTN_DEV = "Разработка систем и платформ"
BTN_AUTOMATION = "Автоматизация процессов"
...
def get_display_name(user) -> str:
    """Выбирает лучшее имя для приветствия: Имя -> Юзернейм -> Пользователь"""
    if user.first_name:
...
def main_menu_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            # Навигация обычного цвета
            [InlineKeyboardButton(text=BTN_SERVICES, callback_data="menu_services"),
             InlineKeyboardButton(text=BTN_CASES, callback_data="menu_cases")],
            # [InlineKeyboardButton(text=BTN_ABOUT, callback_data="menu_about")],
            # Целевое действие — синего цвета, на всю ширину
            [InlineKeyboardButton(text=BTN_CONTACT, callback_data="menu_contact", style="primary")]
        ]
    )
...
def services_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text=BTN_DEV, callback_data="srv_dev")],
            [InlineKeyboardButton(text=BTN_AUTOMATION, callback_data="srv_auto")],
...
def detail_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text=BTN_DISCUSS, callback_data="menu_contact", style="primary")],
...
async def cmd_start(message: Message) -> None:
    ...
    await message.answer(
        TEXT_MAIN_MENU.format(name=get_display_name(message.from_user)),
...
async def handle_cases(callback: CallbackQuery) -> None:
    ...
    # Добавляем link_preview_options=LinkPreviewOptions(is_disabled=True)
...
TGK_TEXT = '''<tg-emoji emoji-id="5330237710655306682">📱</tg-emoji> Наш Telegram-канал:'''
@dp.callback_query(F.data == "menu_about")
async def handle_about(callback: CallbackQuery) -> None:
    await ensure_user(callback)
    await increment_action(callback.from_user.id, "about")
    await callback.message.edit_text(f" {TGK_TEXT} {CHANNEL_URL}", reply_markup=about_inline_kb())
    await callback.answer()
...
async def handle_back(callback: CallbackQuery) -> None:
    ...
    if callback.data == "back_services":
        ...
        await callback.message.edit_text(
            TEXT_MAIN_MENU.format(name=get_display_name(callback.from_user)),
            reply_markup=main_menu_kb()
        )
    await callback.answer()
